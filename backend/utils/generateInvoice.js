...
export const generateInvoicePdf = async (invoice) => {
  ...
  await new Promise((resolve, reject) => {
    ...
    const isSubscriptionInvoice = invoice.billingType === "subscription";

    doc.font("Helvetica-Bold").text(isSubscriptionInvoice ? "Billed To" : "Patient");
    ...
    if (isSubscriptionInvoice) {
      ...
      doc.font("Helvetica").text(invoice.doctor?.specialization || "Subscription");
    } else {
