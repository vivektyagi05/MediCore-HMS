  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-col justify-between gap-4 sm:flex-row sm:items-end">
        <div>
          <p className="text-sm font-black uppercase tracking-[0.18em] text-blue-600">{t("finance.heading")}</p>
          <h1 className="mt-2 text-3xl font-black text-slate-950">{t("finance.heading")}</h1>
        </div>
      ...
      <div className="grid gap-6 lg:grid-cols-3">
        <Card>
          ...
          <p className="mt-4 text-sm font-bold text-slate-500">{t("common.status")}</p>
        ...
        <Card>
          <p className="text-sm font-bold text-slate-500">{t("common.date")}</p>
